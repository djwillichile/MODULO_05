...
fileStrig <- "https://djwillichile.github.io/MODULO_06/DATA/LANDSAT_8.tif"

# Importamos el archivo con la función "stack"
LANDSAT <- stack(fileStrig)
LANDSAT

# Graficamos la segunda banda (verde)
par(mar = c(3, 1.8, 0.3, 1)) #configuramos los márgenes
...
Una aplicación muy extendida del álgebra de mapas en el mundo de los Sistemas de Información Geográfica y la Teledetección el el cálculo de índices espectrales. En concreo ahora realizaremos 2 índices, el Índice de Agua de Diferencia Normalizada (NDWI) y el Índice de Vegetación de Diferencia Normalizada (NDVI)

![Figura 2: Comportamiento espectral de distintas superficies. ](IMG/Firma espectral.jpg){width='100%'}
